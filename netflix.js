...
const api = "api_key=abf7ac78d5a709d0e41e02f36132e432";
...
.then((data) => {
 ...
 // row.classList.add("netflixrow");
  ...
  data.results.forEach((movie) => {
    ...
    // we use this so that movie and data gets placed one by one and cann't get misplaced
